...
class Common(config):
    ...
    def get_hash(self, string, length):
        h = hashlib.sha256()
    ...
    def usign_verify(self, file_path, pubkey):
        key_folder = get_folder("key_folder")
